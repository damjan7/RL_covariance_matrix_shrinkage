    ...
    for epoch in range(1, num_epochs+1):
        ...
        with torch.no_grad():
            for i, data in enumerate(val_dataloader):
                ...
                dst = torch.abs(dst - X[0][-1]/100) * (0.05) # even smaller, since very few stocks
            ...
            if epoch == num_epochs:
                ...
                res_pf_metrics = eval_funcs.calc_pf_metrics_network_estimator(fut_ret_mats, past_ret_mats, mapped_shrkges_v2, val_indices_results)
                res_eval = eval_funcs.temp_eval_fct(mapped_shrkges_v2, fut_ret_mats, past_ret_mats, reb_days, val_indices_results)
                return res_pf_metrics, res_eval
