...
def train_with_dataloader(normalize=False):
    ...
    train_idxes = [i for i in range(4555)]
    val_idxes = [i for i in range(4555, 9553 + 1)]
    val_idxes_v2 = [4555 + i*21 for i in range((9553-4555)//21 + 1)]
...
'''
correct val idxes as in blockbuster paper::: val_idxes_v2
